...
/// Use case to get favorite playlists with pagination.
class GetFavoritePlaylistsUseCase {
  final LibraryRepository _repository;

  GetFavoritePlaylistsUseCase(this._repository);
  ...
  Future<Either<AppException, List<FavoritePlaylistEntity>>> call({
    ...
    return _repository.getFavoritePlaylists(page: page, limit: limit);
  }
}
