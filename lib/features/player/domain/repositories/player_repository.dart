...
abstract class PlayerRepository {
  ...
  Future<Either<AppException, List<Song>>> getHistory({int limit = 50});

  /// Add song to history
  ///
  /// Creates a new history entry for the given song
  Future<Either<AppException, void>> addToHistory(Song song);
  ...
  Future<Either<AppException, String?>> getLocalAudioPath(String videoId);

  /// Check if song is available offline
  ///
  /// Returns true if the song has been downloaded and is available locally
  Future<Either<AppException, bool>> isSongAvailableOffline(String videoId);
